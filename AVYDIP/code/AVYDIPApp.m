classdef AVYDIPApp < handle
    ...
    methods
        ...
        function startApp(obj)
            ...
            mlock;
            AVYDIPApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'page1beta')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong page1beta
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'page1beta').getString, ...
            ...
            if nargout(@page1beta) == 0
                eval('page1beta');
            else
                obj.AppHandle = eval('page1beta');
            end
